          ...
          <ThemeProvider theme={theme}>
               <>
                    ...
                    <main className={classes.main}>
                         <div className={classes.box} style={{ margin: '15% 0' }}>
                                                                                               ...
                                                                                               <Grid container spacing={2} justify="center">
                                                                                                    <Grid item xs={10}>
                                                                                                         <Typography gutterBottom>
                                                                                                              <Link href="www.google.com" target='_blank' color="inherit" style={{ color: 'white', fontWeight: 'Bold' }}>www.Google.com</Link>
                                                                                                         </Typography>
                                                                                     ...
                                                                                     <CardContent className={classes.cardContent}>
                                                                                          <div>
                                                                                               <Grid container spacing={2} justify="center">
                                                                                                    <Grid item xs={10}>
                                                                                                         <Typography gutterBottom>
                                                                                                              <Link href="www.google.com" target='_blank' color="inherit" style={{ color: 'white', fontWeight: 'Bold' }}>www.Google Two.com</Link>
                                                                                                         </Typography>
                                                                                                         <Typography style={{ color: 'white' }}>
                                                                                                              Google Two
                                                                                                         </Typography>
